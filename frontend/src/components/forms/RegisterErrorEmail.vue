<template>
  <div class="register--fail--email--container fade-In">
    <div class="text">
      <h3>{{ $t("errorTitle") }}</h3>
      <p
        id="sub--title"
...
export default {
  ...
  setup() {
    ...
    const registrationErrorEmailText = t("registrationErrorEmailText");

    return {
      errorTitle,
      registrationErrorEmailText,
